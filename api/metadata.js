module.exports.do = function(req, res){
    res.status(200).send({
        ...
        'blocks': [{
            ...
            "name":"indexHtmlDocument",
            "description": "Prepares a `html` document for the Retrieve and Rank service as part of an Enhanced Information Retrieval solution, then adds the content to your Solr index so you can search it.",
            "args":[
                {
                    name: "username",
                    type: "credentials",
            ...
            "name":"indexPDFDocument",
            "description": "Prepares a `pdf` document for the Retrieve and Rank service as part of an Enhanced Information Retrieval solution, then adds the content to your Solr index so you can search it.",
            "args":[
                {
                    name: "username",
                    type: "credentials",
            ...
            "name":"indexMicrosoftWordDocument",
            "description": "Prepares a `msword` document for the Retrieve and Rank service as part of an Enhanced Information Retrieval solution, then adds the content to your Solr index so you can search it.",
            "args":[
                {
                    name: "username",
                    type: "credentials",
